	...
	<Components>
		...
		<Grid id="10" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="20" connection="SMART" dataSource="smart_ticket" activeCollection="TableParameters" orderBy="tckt_refnumber desc" name="smart_ticket" pageSizeLimit="100" wizardCaption="List of Smart Ticket " wizardGridType="Tabular" wizardSortingType="Extended" wizardAllowInsert="False" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="True" wizardNoRecords="No records">
			<Components>
				...
				<Sorter id="14" visible="True" name="Sorter_tckt_adukom" column="tckt_adukomn" wizardCaption="Tckt Status" wizardSortingType="Extended" wizardControl="tckt_status" wizardAddNbsp="False" PathID="smart_ticketSorter_tckt_adukom" connection="SMART">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<IncludePage id="36" name="smartmap" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="smartmap" page="smartmap.ccp">
<Components/>
<Events/>
<Features/>
</IncludePage>
<IncludePage id="37" name="smartheader" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="smartheader" page="smartheader.ccp">
<Components/>
<Events/>
<Features/>
</IncludePage>
