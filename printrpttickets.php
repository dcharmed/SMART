<?php
//Include Common Files @1-8A08DECC
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "printrpttickets.php");
...
//RTicket ReportGroup class @2-DAFF5149
class clsReportGroupRTicket {
    var $GroupType;
    ...
    function clsReportGroupRTicket(& $parent) {
        $this->Parent = & $parent;
...
//RTicket GroupsCollection class @2-71F9FA85
class clsGroupsCollectionRTicket {
    var $Groups;
    ...
    function clsGroupsCollectionRTicket(& $parent) {
        $this->Parent = & $parent;
        $this->Groups = array();
        $this->Pages  = array();
    ...
    function & InitGroup() {
        $group = new clsReportGroupRTicket($this->Parent);
...
class clsReportRTicket { //RTicket Class @2-EEE9CA2A
...
//Class_Initialize Event @2-2D479542
    function clsReportRTicket($RelativePath = "", & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        ...
        $this->DataSource = new clsRTicketDataSource($this);
        ...
        if(is_numeric($PageSize) && $PageSize > 0) {
            ...
            if (!is_numeric($PageSize) || $PageSize < 0)
                ...
                $this->PageSize = min(20000, $PageSize);
        }
...
//Show Method @2-D110240F
    function Show()
    {
        ...
        $tckt_refnumberKey = "";
        $Groups = new clsGroupsCollectionRTicket($this);
...
class clsRTicketDataSource extends clsDBSMART {  //RTicketDataSource Class @2-CE51694C
...
//DataSourceClass_Initialize Event @2-87C70813
    function clsRTicketDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "printrpttickets.html";
$BlockToParse = "main";
...
//Include events file @1-FC1921AB
include_once("./printrpttickets_events.php");
...
// Controls
$RTicket = & new clsReportRTicket("", $MainPage);
$MainPage->RTicket = & $RTicket;
$RTicket->Initialize();
...
//Go to destination page @1-BB6D6586
if($Redirect)
{
