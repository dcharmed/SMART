...
" isCaption="true">
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="reportgraphtest.php" forShow="True" url="reportgraph.php" comment="//" codePage="windows-1252"/>
		<CodeFile id="FlashChartXML5" language="PHPTemplates" name="reportgraphtestFlashChart1.xml" forShow="False" comment="&lt;!--" commentEnd="--&gt;" codePage="windows-1252"/>
		<CodeFile id="Events" language="PHPTemplates" name="reportgraphtest_events.php" forShow="False" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
