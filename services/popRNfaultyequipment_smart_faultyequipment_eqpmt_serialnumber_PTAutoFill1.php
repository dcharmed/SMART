<?php
//Include Common Files @1-385F6327
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "popRNfaultyequipment_smart_faultyequipment_eqpmt_serialnumber_PTAutoFill1.php");
...
//Class_Initialize Event @2-679F1F98
...
//DataSource Variables @2-7CCB0DC4
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-2BA77090
...
//Prepare Method @2-16FCF7BB
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "eqpmt_serialnumber", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),true);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "popRNfaultyequipment_smart_faultyequipment_eqpmt_serialnumber_PTAutoFill1.html";
$BlockToParse = "main";
