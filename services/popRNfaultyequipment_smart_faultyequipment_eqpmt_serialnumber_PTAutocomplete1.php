<?php
//Include Common Files @1-538FDEE6
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "popRNfaultyequipment_smart_faultyequipment_eqpmt_serialnumber_PTAutocomplete1.php");
...
//Class_Initialize Event @2-AF1B0665
...
//Show Method @2-78C73DAE
    function Show()
    {
        ...
        $this->DataSource->Parameters["posteqpmt_serialnumber"] = CCGetFromPost("eqpmt_serialnumber", NULL);
...
//DataSourceClass_Initialize Event @2-007DF0F1
...
//Prepare Method @2-21C41E4C
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "posteqpmt_serialnumber", ccsText, "", "", $this->Parameters["posteqpmt_serialnumber"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "eqpmt_serialnumber", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "popRNfaultyequipment_smart_faultyequipment_eqpmt_serialnumber_PTAutocomplete1.html";
$BlockToParse = "main";
