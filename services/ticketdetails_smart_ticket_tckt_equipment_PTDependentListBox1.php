<?php
//Include Common Files @1-645F53A8
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "ticketdetails_smart_ticket_tckt_equipment_PTDependentListBox1.php");
...
//Class_Initialize Event @2-9C738E44
...
//DataSource Variables @2-7FC6D069
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-13FCCBE6
...
//Prepare Method @2-B65C0357
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "eqpmt_branch", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),true);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method
...
//SetValues Method @2-52DD4759
    function SetValues()
    {
        $this->eqpmt_code->SetDBValue($this->f("id"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ticketdetails_smart_ticket_tckt_equipment_PTDependentListBox1.html";
$BlockToParse = "main";
