...
<Features/>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="ticketdetails_smart_ticket_tckt_subcatdet_PTDependentListBox1.php" forShow="True" url="ticketdetails_smart_ticket_tckt_subcatdet_PTDependentListBox1.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
