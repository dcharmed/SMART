<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="True" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" needGeneration="0" wizardTheme="{CCS_Style}" wizardThemeVersion="3.0">
	<Components>
		<Record id="12" sourceType="Table" urlType="Relative" secured="False" allowInsert="0" allowUpdate="0" allowDelete="0" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="SMART" name="smart_user" dataSource="smart_user, smart_referencecode" errorSummator="Error" wizardCaption="View Smart User " wizardFormMethod="post" PathID="smartheadersmart_user" pasteActions="pasteActions" activeCollection="TableParameters">
			<Components>
				<Link id="3" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Logout" hrefSource="index.ccp" wizardDefaultValue="Logout" PathID="smartheadersmart_userLogout" removeParameters="s_state;s_branch;s_ref;s_sdate;s_edate;s_svr;mode;new;view;edit;id;tcktid;rid;eqid;smart_ticketOrder;smart_ticketDir;s_svr">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="8" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link1" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="smartheadersmart_userLink1" hrefSource="myaccount.ccp" wizardUseTemplateBlock="False" removeParameters="s_state;s_branch;s_ref;s_sdate;s_edate;s_svr;mode;new;view;edit;id;tcktid;rid;eqid;smart_ticketOrder;smart_ticketDir;s_svr">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Label id="18" fieldSourceType="DBColumn" dataType="Text" html="False" name="usr_fullname" fieldSource="usr_fullname" required="True" caption="Usr Fullname" wizardCaption="Usr Fullname" wizardSize="50" wizardMaxLength="250" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="smartheadersmart_userusr_fullname">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="20" fieldSourceType="DBColumn" dataType="Text" html="False" name="usr_group" fieldSource="ref_description" required="True" caption="Usr Group" wizardCaption="Usr Group" wizardSize="10" wizardMaxLength="10" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="smartheadersmart_userusr_group">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="22" fieldSourceType="DBColumn" dataType="Date" html="False" name="usr_lastlogged" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="smartheadersmart_userusr_lastlogged" fieldSource="usr_lastlogged" format="GeneralDate">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<IncludePage id="47" name="smartnavmenu" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="smartheadersmartnavmenu" page="smartnavmenu.ccp">
			<Components/>
			<Events/>
			<Features/>
		</IncludePage>
		<Label id="49" fieldSourceType="DBColumn" dataType="Date" html="False" name="TodayDate" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="smartheaderTodayDate" format="dddd, d mmmm yyyy hh:nn AM/PM" defaultValue="CurrentDateTime">
			<Components/>
			<Events/>
			<Attributes/>
			<Features/>
		</Label>
		<ImageLink id="54" visible="Yes" fieldSourceType="DBColumn" dataType="Text" hrefType="Page" urlType="Relative" preserveParameters="GET" name="logo" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="smartheaderlogo" hrefSource="mainpage.ccp">
			<Components/>
			<Events/>
			<LinkParameters/>
			<Attributes/>
		...
		<Record id="23" sourceType="Table" urlType="Relative" secured="False" allowInsert="0" allowUpdate="0" allowDelete="0" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="SMART" name="smart_ticket" dataSource="smart_ticket" errorSummator="Error" wizardCaption="View Smart Ticket " wizardFormMethod="post" PathID="smartheadersmart_ticket" pasteActions="pasteActions">
			<Components>
				...
				<Link id="33" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="lblMajor" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="smartheadersmart_ticketlblMajor" hrefSource="ticketlist.ccp" wizardUseTemplateBlock="False" fieldSource="tcktMajor" defaultValue="0" removeParameters="s_state;s_branch;s_ref;s_sdate;s_edate;s_svr;mode;new;view;edit;id;tcktid;rid;eqid">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="51" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Link1" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="smartheadersmart_ticketLink1" hrefSource="ticketlist.ccp" wizardUseTemplateBlock="False" removeParameters="s_svr;s_sdate;s_edate;">
					<Components/>
					<Events/>
					<LinkParameters/>
					<Attributes/>
			...
			<Fields>
				...
				<Field id="37" fieldName="SUM(IF(tckt_status&lt;7 AND tckt_severity=1,1,0))" isExpression="True" alias="tcktCritical"/>
				<Field id="38" fieldName="SUM(IF(tckt_status&lt;7 AND tckt_severity=2,1,0))" isExpression="True" alias="tcktMajor"/>
				<Field id="39" fieldName="SUM(IF(tckt_status&lt;7 AND tckt_severity=3,1,0))" isExpression="True" alias="tcktMinor"/>
				<Field id="40" fieldName="SUM(IF(tckt_status&lt;7 AND tckt_severity=4,1,0))" isExpression="True" alias="tcktInfo"/>
			</Fields>
			<ISPParameters/>
			<ISQLParameters/>
			<IFormElements/>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="smartheader.php" forShow="True" url="smartheader.php" comment="//" codePage="windows-1252"/>
		<CodeFile id="Events" language="PHPTemplates" name="smartheader_events.php" forShow="False" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
	...
	<Events>
		<Event name="AfterInitialize" type="Server">
			<Actions>
				<Action actionName="Logout" actionCategory="Security" id="5" pageRedirects="True" parameterName="Logout" returnPage="smartheader.ccp"/>
