...
//Initialize Method @1-916FA08E
    function Initialize()
    {
        ...
        $this->TodayDate = & new clsControl(ccsLabel, "TodayDate", "TodayDate", ccsDate, array("dddd", ", ", "mmmm", " ", "d", ", ", "yyyy"), CCGetRequestParam("TodayDate", ccsGet, NULL), $this);
