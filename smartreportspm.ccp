<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="{CCS_Style}" wizardThemeVersion="3.0" pasteActions="pasteActions" needGeneration="0">
	<Components>
		...
		<IncludePage id="5" name="reportspm" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="reportspm" page="reportspm.ccp">
<Components/>
<Events/>
<Features/>
</IncludePage>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="smartreportspm.php" forShow="True" url="smartreportspm.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
