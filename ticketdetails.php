<?php
//Include Common Files @1-BB5B6C9D
define("RelativePath", ".");
...
"FROM smart_user {SQL_Where} {SQL_OrderBy}";
			...
			$this->tckt_method = & new clsControl(ccsTextBox, "tckt_method", "Resolution Method", ccsText, "", CCGetRequestParam("tckt_method", $Method, NULL), $this);
			$this->tckt_method->Required = false;
			$this->tckt_followup = & new clsControl(ccsCheckBox, "tckt_followup", "To Follow-up", ccsInteger, $CCSLocales->GetFormatInfo("IntegerFormat"), CCGetRequestParam("tckt_followup", $Method, NULL), $this);
            $this->tckt_followup->CheckedValue = 1;
            $this->tckt_followup->UncheckedValue = 0;
...
//Validate Method @5-9B663B31
    function Validate()
    {
        ...
        $Validation = ($this->tckt_followup->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->tckt_followup->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @5-64A72EF6
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->tckt_followup->Errors->Count());
...
//InsertRow Method @5-F881B063
    function InsertRow()
    {
        ...
        $this->DataSource->tckt_method->SetValue($this->tckt_method->GetValue(true));
        $this->DataSource->tckt_followup->SetValue($this->tckt_followup->GetValue(true));
...
//Show Method @5-16E3F7D9
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->tckt_followup->Errors->ToString());
...
//DataSource Variables @5-8C49FE25
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @5-EFB3D36D
    function clssmart_ticketDataSource(& $Parent)
    {
        ...
        $this->tckt_followup = new clsField("tckt_followup", ccsInteger, "");
        ...
        $this->InsertFields["tckt_c_method"] = array("Name" => "tckt_c_method", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["tckt_followup"] = array("Name" => "tckt_followup", "Value" => "", "DataType" => ccsInteger);
        ...
        $this->UpdateFields["tckt_c_method"] = array("Name" => "tckt_c_method", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->UpdateFields["tckt_followup"] = array("Name" => "tckt_followup", "Value" => "", "DataType" => ccsInteger);
    }
...
//SetValues Method @5-0675C460
    function SetValues()
    {
        ...
        $this->tckt_followup->SetDBValue(trim($this->f("tckt_followup")));
    }
//End SetValues Method

//Insert Method @5-01EEB9F9
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->InsertFields["tckt_c_method"]["Value"] = $this->tckt_method->GetDBValue(true);
        $this->InsertFields["tckt_followup"]["Value"] = $this->tckt_followup->GetDBValue(true);
...
//Update Method @5-F2170F3D
    function Update()
    {
        ...
        $this->UpdateFields["tckt_c_method"]["Value"] = $this->tckt_method->GetDBValue(true);
        $this->UpdateFields["tckt_followup"]["Value"] = $this->tckt_followup->GetDBValue(true);
...
//Class_Initialize Event @158-7CF6781A
    function clsGridGResNote($RelativePath, & $Parent)
    {
        ...
        $this->rsltn_spart = & new clsControl(ccsLabel, "rsltn_spart", "rsltn_spart", ccsText, "", CCGetRequestParam("rsltn_spart", ccsGet, NULL), $this);
        $this->rsltn_eq = & new clsControl(ccsLabel, "rsltn_eq", "rsltn_eq", ccsText, "", CCGetRequestParam("rsltn_eq", ccsGet, NULL), $this);
        $this->rsltn_att = & new clsControl(ccsLabel, "rsltn_att", "rsltn_att", ccsText, "", CCGetRequestParam("rsltn_att", ccsGet, NULL), $this);
...
//Show Method @158-4500E10D
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["rsltn_spart"] = $this->rsltn_spart->Visible;
            $this->ControlsVisible["rsltn_eq"] = $this->rsltn_eq->Visible;
            $this->ControlsVisible["rsltn_att"] = $this->rsltn_att->Visible;
...
//GetErrors Method @158-236912ED
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->rsltn_spart->Errors->ToString());
        $errors = ComposeStrings($errors, $this->rsltn_eq->Errors->ToString());
        $errors = ComposeStrings($errors, $this->rsltn_att->Errors->ToString());
...
//DataSource Variables @158-D3B920A2
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @158-21B0D2AA
...
//Class_Initialize Event @95-80A7B105
...
//CheckErrors Method @95-A6CC6E87
    function CheckErrors()
    {
        $errors = false;
...
//DataSource Variables @95-3D0DFCDE
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @95-39670E44
...
"FROM smart_user {SQL_Where} {SQL_OrderBy}";
            ...
            $this->task_personincharge->DataSource->Parameters["expr47"] = 3;
            $this->task_personincharge->DataSource->Parameters["expr199"] = 5;
            $this->task_personincharge->DataSource->Parameters["expr353"] = 1;
            $this->task_personincharge->DataSource->Parameters["expr355"] = 0;
            $this->task_personincharge->DataSource->wp = new clsSQLParameters();
            $this->task_personincharge->DataSource->wp->AddParameter("1", "expr47", ccsInteger, "", "", $this->task_personincharge->DataSource->Parameters["expr47"], "", false);
            $this->task_personincharge->DataSource->wp->AddParameter("2", "expr199", ccsInteger, "", "", $this->task_personincharge->DataSource->Parameters["expr199"], "", false);
            $this->task_personincharge->DataSource->wp->AddParameter("3", "expr353", ccsInteger, "", "", $this->task_personincharge->DataSource->Parameters["expr353"], "", false);
            $this->task_personincharge->DataSource->wp->AddParameter("4", "expr355", ccsInteger, "", "", $this->task_personincharge->DataSource->Parameters["expr355"], "", false);
            $this->task_personincharge->DataSource->wp->Criterion[1] = $this->task_personincharge->DataSource->wp->Operation(opGreaterThanOrEqual, "usr_group", $this->task_personincharge->DataSource->wp->GetDBValue("1"), $this->task_personincharge->DataSource->ToSQL($this->task_personincharge->DataSource->wp->GetDBValue("1"), ccsInteger),false);
            $this->task_personincharge->DataSource->wp->Criterion[2] = $this->task_personincharge->DataSource->wp->Operation(opLessThanOrEqual, "usr_group", $this->task_personincharge->DataSource->wp->GetDBValue("2"), $this->task_personincharge->DataSource->ToSQL($this->task_personincharge->DataSource->wp->GetDBValue("2"), ccsInteger),false);
            $this->task_personincharge->DataSource->wp->Criterion[3] = $this->task_personincharge->DataSource->wp->Operation(opEqual, "usr_status", $this->task_personincharge->DataSource->wp->GetDBValue("3"), $this->task_personincharge->DataSource->ToSQL($this->task_personincharge->DataSource->wp->GetDBValue("3"), ccsInteger),false);
            $this->task_personincharge->DataSource->wp->Criterion[4] = $this->task_personincharge->DataSource->wp->Operation(opEqual, "usr_flag", $this->task_personincharge->DataSource->wp->GetDBValue("4"), $this->task_personincharge->DataSource->ToSQL($this->task_personincharge->DataSource->wp->GetDBValue("4"), ccsInteger),false);
            $this->task_personincharge->DataSource->Where = $this->task_personincharge->DataSource->wp->opAND(
                 false, $this->task_personincharge->DataSource->wp->opAND(
                 false, $this->task_personincharge->DataSource->wp->opAND(
                 false, 
                 $this->task_personincharge->DataSource->wp->Criterion[1], 
                 $this->task_personincharge->DataSource->wp->Criterion[2]), 
                 $this->task_personincharge->DataSource->wp->Criterion[3]), 
                 $this->task_personincharge->DataSource->wp->Criterion[4]);
...
"FROM smart_user {SQL_Where} {SQL_OrderBy}";
            ...
            $this->task_secpersonincharge->DataSource->Parameters["expr47"] = 3;
            $this->task_secpersonincharge->DataSource->Parameters["expr199"] = 5;
            $this->task_secpersonincharge->DataSource->Parameters["expr353"] = 1;
            $this->task_secpersonincharge->DataSource->Parameters["expr355"] = 0;
            $this->task_secpersonincharge->DataSource->wp = new clsSQLParameters();
            $this->task_secpersonincharge->DataSource->wp->AddParameter("1", "expr47", ccsInteger, "", "", $this->task_secpersonincharge->DataSource->Parameters["expr47"], "", false);
            $this->task_secpersonincharge->DataSource->wp->AddParameter("2", "expr199", ccsInteger, "", "", $this->task_secpersonincharge->DataSource->Parameters["expr199"], "", false);
            $this->task_secpersonincharge->DataSource->wp->AddParameter("3", "expr353", ccsInteger, "", "", $this->task_secpersonincharge->DataSource->Parameters["expr353"], "", false);
            $this->task_secpersonincharge->DataSource->wp->AddParameter("4", "expr355", ccsInteger, "", "", $this->task_secpersonincharge->DataSource->Parameters["expr355"], "", false);
            $this->task_secpersonincharge->DataSource->wp->Criterion[1] = $this->task_secpersonincharge->DataSource->wp->Operation(opGreaterThanOrEqual, "usr_group", $this->task_secpersonincharge->DataSource->wp->GetDBValue("1"), $this->task_secpersonincharge->DataSource->ToSQL($this->task_secpersonincharge->DataSource->wp->GetDBValue("1"), ccsInteger),false);
            $this->task_secpersonincharge->DataSource->wp->Criterion[2] = $this->task_secpersonincharge->DataSource->wp->Operation(opLessThanOrEqual, "usr_group", $this->task_secpersonincharge->DataSource->wp->GetDBValue("2"), $this->task_secpersonincharge->DataSource->ToSQL($this->task_secpersonincharge->DataSource->wp->GetDBValue("2"), ccsInteger),false);
            $this->task_secpersonincharge->DataSource->wp->Criterion[3] = $this->task_secpersonincharge->DataSource->wp->Operation(opEqual, "usr_status", $this->task_secpersonincharge->DataSource->wp->GetDBValue("3"), $this->task_secpersonincharge->DataSource->ToSQL($this->task_secpersonincharge->DataSource->wp->GetDBValue("3"), ccsInteger),false);
            $this->task_secpersonincharge->DataSource->wp->Criterion[4] = $this->task_secpersonincharge->DataSource->wp->Operation(opEqual, "usr_flag", $this->task_secpersonincharge->DataSource->wp->GetDBValue("4"), $this->task_secpersonincharge->DataSource->ToSQL($this->task_secpersonincharge->DataSource->wp->GetDBValue("4"), ccsInteger),false);
            $this->task_secpersonincharge->DataSource->Where = $this->task_secpersonincharge->DataSource->wp->opAND(
                 false, $this->task_secpersonincharge->DataSource->wp->opAND(
                 false, $this->task_secpersonincharge->DataSource->wp->opAND(
                 false, 
                 $this->task_secpersonincharge->DataSource->wp->Criterion[1], 
                 $this->task_secpersonincharge->DataSource->wp->Criterion[2]), 
                 $this->task_secpersonincharge->DataSource->wp->Criterion[3]), 
                 $this->task_secpersonincharge->DataSource->wp->Criterion[4]);
			...
			$this->task_date = & new clsControl(ccsTextBox, "task_date", "Task Date", ccsText, "", CCGetRequestParam("task_date", $Method, NULL), $this);
			...
			$this->rsltn_actionmethod = & new clsControl(ccsRadioButton, "rsltn_actionmethod", "Method", ccsInteger, "", CCGetRequestParam("rsltn_actionmethod", $Method, NULL), $this);
            $this->rsltn_actionmethod->DSType = dsTable;
            $this->rsltn_actionmethod->DataSource = new clsDBSMART();
            $this->rsltn_actionmethod->ds = & $this->rsltn_actionmethod->DataSource;
            $this->rsltn_actionmethod->DataSource->SQL = "SELECT * \n" .
"FROM smart_referencecode {SQL_Where} {SQL_OrderBy}";
            list($this->rsltn_actionmethod->BoundColumn, $this->rsltn_actionmethod->TextColumn, $this->rsltn_actionmethod->DBFormat) = array("ref_value", "ref_description", "");
            $this->rsltn_actionmethod->DataSource->Parameters["expr89"] = rsltnmethod;
            $this->rsltn_actionmethod->DataSource->wp = new clsSQLParameters();
            $this->rsltn_actionmethod->DataSource->wp->AddParameter("1", "expr89", ccsText, "", "", $this->rsltn_actionmethod->DataSource->Parameters["expr89"], "", false);
            $this->rsltn_actionmethod->DataSource->wp->Criterion[1] = $this->rsltn_actionmethod->DataSource->wp->Operation(opEqual, "ref_type", $this->rsltn_actionmethod->DataSource->wp->GetDBValue("1"), $this->rsltn_actionmethod->DataSource->ToSQL($this->rsltn_actionmethod->DataSource->wp->GetDBValue("1"), ccsText),false);
            $this->rsltn_actionmethod->DataSource->Where = 
                 $this->rsltn_actionmethod->DataSource->wp->Criterion[1];
            $this->rsltn_actionmethod->Required = false;
...
//CheckErrors Method @90-C7AB4E91
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->ticket_id->Errors->Count());
...
//DataSource Variables @90-040E75AD
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @90-C91C96AC
    function clssmart_taskDataSource(& $Parent)
    {
        ...
        $this->task_date = new clsField("task_date", ccsText, "");
...
//Open Method @90-87576725
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT tckt_status, id, tckt_c_helpdesk, tckt_c_date, tckt_c_adukomid, tckt_c_byuser, datemodified, tckt_c_method \n\n" .
        "FROM smart_ticket {SQL_Where} {SQL_OrderBy}";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->PageSize = 1;
        $this->query($this->OptimizeSQL(CCBuildSQL($this->SQL, $this->Where, $this->Order)));
...
//SetValues Method @90-5147EE83
    function SetValues()
    {
        ...
        $this->task_date->SetDBValue($this->f("task_date"));
        $this->rsltn_actionmethod->SetDBValue($this->f("tckt_c_method"));
    }
//End SetValues Method

//Update Method @90-15ED61DC
    function Update()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->cp["tckt_c_method"] = new clsSQLParameter("ctrlrsltn_actionmethod", ccsText, "", "", $this->rsltn_actionmethod->GetValue(true), NULL, false, $this->ErrorBlock);
        ...
        if (!is_null($this->cp["tckt_c_method"]->GetValue()) and !strlen($this->cp["tckt_c_method"]->GetText()) and !is_bool($this->cp["tckt_c_method"]->GetValue())) 
            $this->cp["tckt_c_method"]->SetValue($this->rsltn_actionmethod->GetValue(true));
        ...
        $this->UpdateFields["tckt_c_method"]["Value"] = $this->cp["tckt_c_method"]->GetDBValue(true);
        $this->SQL = CCBuildUpdate("smart_ticket", $this->UpdateFields, $this);
