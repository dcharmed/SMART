...
function BindEvents()
{
    ...
    $smart_ticketSearch->s_branch->CCSEvents["BeforeShow"] = "smart_ticketSearch_s_branch_BeforeShow";
...
//smart_ticketSearch_s_branch_BeforeShow @77-99C6CAA1
function smart_ticketSearch_s_branch_BeforeShow(& $sender)
{
    $smart_ticketSearch_s_branch_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $smart_ticketSearch; //Compatibility
//End smart_ticketSearch_s_branch_BeforeShow

//Close smart_ticketSearch_s_branch_BeforeShow @77-62DCAB3B
    return $smart_ticketSearch_s_branch_BeforeShow;
}
//End Close smart_ticketSearch_s_branch_BeforeShow
...
//Page_AfterInitialize @1-E5B579A6
function Page_AfterInitialize(& $sender)
{
    $Page_AfterInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $ticketlist; //Compatibility
...
//Page_BeforeInitialize @1-6AD15381
